...
$(document).ready(function(e) {
	...
	$('.insuranceCobrandingTr').click(function(){
	...
	$('.insuranceCobrandingTl').click(function(){
...
$(document).ready(function(){
	$('.insuranceCobrandingTl,.insuranceCobrandingTr').hover(function(){
			$(this).fadeTo('fast',1);
		},function(){
